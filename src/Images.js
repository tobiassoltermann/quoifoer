...
import SX from './img/SX.svg'
import SJ from './img/SJ.svg'
import SQ from './img/SQ.svg'
import SK from './img/SK.svg'
import SA from './img/SA.svg'

import K6 from './img/K6.svg'
import K7 from './img/K7.svg'
import K8 from './img/K8.svg'
import K9 from './img/K9.svg'
import KX from './img/KX.svg'
import KJ from './img/KJ.svg'
import KQ from './img/KQ.svg'
import KK from './img/KK.svg'
